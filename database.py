...
def save_batch(slug, owner_id, channel_id, msg_count, batch_type, is_premium, messages):
    """
    Save batch with full details.
    """
    try:
        batch_doc = {
            "slug": slug,
            ...
            "msg_count": msg_count,
            "type": batch_type,          # file/vid/aud/pht/sti/ani/text/mix
